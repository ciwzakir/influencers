...
const VerifificationDetails = ({ params }: any) => {
  ...
  return (
    <Content style={{ padding: "0px", backgroundColor: "#f0f2f5" }}>
          ...
          <Col xs={24} md={14}>
            <Space direction="vertical" size="middle" style={{ width: "100%" }}>
              ...
              <Text style={{ fontSize: 16, color: "#555" }}>
                <small>
                  The amount receivable for the month of{" "}
                  <strong>
                  ...
                  is payable per share as he has{" "}
                  {profileDataLoad?.member_info?.share} share for this Month. As
                  he has to pay {data?.receivable_month?.contribution_amount}{" "}
                  {"x"} {profileDataLoad?.member_info?.share} = {data?.amount} .
                  Payment is due on{" "}
                  <strong>
                    <u>{formatDate(data?.entry_date)}</u>
                  </strong>
                </small>
                {" ."}
              </Text>
      ...
      <Card>
        <Row justify="end">
          <Link href={`/${user_role}/collections/verification/edit/${id}`}>
...
export default VerifificationDetails;
